...
/***/ function(module, exports, __webpack_require__) {
	...
	var _maquette = __webpack_require__(2);
	
	var _maquette2 = _interopRequireDefault(_maquette);
	...
	var h = _maquette2.default.h;
	var projector = _maquette2.default.createProjector();
	...
	var LoadMore = {
	  ...
	  handleLoadMore: function handleLoadMore(button) {
	    var self = this,
	      ...
	      */
	      ...
	      (0, _reqwest2.default)({
	        ...
	        complete: function complete(data) {
	          ...
	          var cData = JSON.parse(data.response);
	          var queriedPosts = cData.posts;
	          ...
	          */
	          ...
	          Array.from(queriedPosts, function (post) {
	            var formattedDate = (0, _moment2.default)(post.date).format('M d Y');
	
	            var lData = function lData() {
	              return h('article.tease tease-post', { id: post.id }, [h('div', [h('img.tease--news-image', { src: post.thumbnail_images.full.url }).h('span.tease--date', formattedDate)]), h('div.tease--text-content', [h('h5', { innerHTML: post.title }), h('div.tease--text-content', post.content)])]);
	            };
